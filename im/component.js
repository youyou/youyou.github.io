...
function CreateTabBar( parent_node )
{
  var tab_bar = CCLayer.create();
  tab_bar.setDepth(100);

  parent_node.addChild(tab_bar);
  ...
  tab_bar.layout( parent_node.width, parent_node.height);

  tab_bar.parent = parent_node;
