...
function CCLabel_instance(parent_instance, str) {
    ...
    var textNode = parent_instance.element.childNodes.item("__label_text__");
    if( !textNode )
    {
        textNode = document.createElement("div");
        parent_instance.element.appendChild(textNode);
        textNode.setAttribute( "id", "__label_text__");
        textNode.style.width = "%100";
        textNode.style.height = "%100";
        textNode.style['font-family'] = "Familiar";
    }
    parent_instance.textNode = textNode;
...
>>>>>>> 482ecc911972a6cc54eb3968b2cbaf50c9856ac3:ground_station/cocos2d-adapter.js
    ...
    parent_instance.setTextAlign = function (align) {
        parent_instance.textNode.style['text-align'] = align;
    };

    parent_instance.setFontSize = function (size) {
        parent_instance.textNode.style['font-size'] = size + "px";
    ...
    parent_instance.textNode.style['text-align'] = "center";
